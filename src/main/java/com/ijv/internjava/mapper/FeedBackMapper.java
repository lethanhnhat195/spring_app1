...
public class FeedBackMapper {
    ...
    public Feedbacks toEntity(FeedbackDto feedbackDto) {
        ...
        Services services = fetchServiceEntity(feedbackDto.setServiceId());
    ...
    private Services fetchServiceEntity(Integer serviceId) {
        return entityManager.find(Services.class, serviceId);
    }
